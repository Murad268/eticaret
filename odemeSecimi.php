...
<div class="cartWrapper">
      ...
      <div class="cartKargoWrapper">
         ...
         <div class="turWrapper">
            <div class="kart">
               ...
               <input checked type="radio" name="var" id="var1">
            </div>
            <div class="bank">
               <img src="assets/images/Banka80x75.png" alt="">
               <label for="var2"></label>
               <input type="radio" name="var" id="var2">
            </div>
         </div>
         <div class="kart__content content">
            ...
            <div class="kart__content__wrapper__taksitler">
               <div class="kart__content__wrapper__taksit">
                  <input type="radio" name="taksit" id="tak1"> <label for="tak1">Tek Çekim</label> <div class="taksitOdeme">1 x <?=fiyatBitimlerndir($toplam)?> TL</div><div class="tamOdeme"><?=$toplam?> TL</div>
               </div>
               <div class="kart__content__wrapper__taksit">
                  <input type="radio" name="taksit" id="tak2"> <label for="tak2">2 Taksit</label> <div class="taksitOdeme">2 x <?=fiyatBitimlerndir($toplam/2)?> TL</div><div class="tamOdeme"><?=$toplam?> TL</div>
               </div>
               <div class="kart__content__wrapper__taksit">
                  <input type="radio" name="taksit" id="tak3"> <label for="tak3">3 Taksit</label> <div class="taksitOdeme">3 x <?=fiyatBitimlerndir($toplam/3)?> TL</div><div class="tamOdeme"><?=$toplam?> TL</div>
               </div>
               <div class="kart__content__wrapper__taksit">
                  <input type="radio" name="taksit" id="tak4"> <label for="tak4">4 Taksit</label> <div class="taksitOdeme">4 x <?=fiyatBitimlerndir($toplam/4)?> TL</div><div class="tamOdeme"><?=$toplam?> TL</div>
               </div>
               <div class="kart__content__wrapper__taksit">
                  <input type="radio" name="taksit" id="tak5"> <label for="tak5">5 Taksit</label> <div class="taksitOdeme">5 x <?=fiyatBitimlerndir($toplam/5)?> TL</div><div class="tamOdeme"><?=$toplam?> TL</div>
               </div>
               <div class="kart__content__wrapper__taksit">
                  <input type="radio" name="taksit" id="tak6"> <label for="tak6">6 Taksit</label> <div class="taksitOdeme">6 x <?=fiyatBitimlerndir($toplam/6)?> TL</div><div class="tamOdeme"><?=$toplam?> TL</div>
               </div>
               <div class="kart__content__wrapper__taksit">
                  <input type="radio" name="taksit" id="tak7"> <label for="tak7">7 Taksit</label> <div class="taksitOdeme">7 x <?=fiyatBitimlerndir($toplam/7)?> TL</div><div class="tamOdeme"><?=$toplam?> TL</div>
               </div>
               <div class="kart__content__wrapper__taksit">
                  <input type="radio" name="taksit" id="tak8"> <label for="tak8">8 Taksit</label> <div class="taksitOdeme">8 x <?=fiyatBitimlerndir($toplam/8)?> TL</div><div class="tamOdeme"><?=$toplam?> TL</div>
               </div>
               <div class="kart__content__wrapper__taksit">
                  <input type="radio" name="taksit" id="tak9"> <label for="tak9">9 Taksit</label> <div class="taksitOdeme">9 x <?=fiyatBitimlerndir($toplam/9)?> TL</div><div class="tamOdeme"><?=$toplam?> TL</div>
               </div>
            </div>
         </div>
   ...
   <div class="cartWrapper__order">
      ...
      <a class="btn cartWrapper__order__btn"><span>ÖDEME YAP</a>
   </div>
</div>