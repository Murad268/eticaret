...
<div class="manWrapper">
   <div class="manWrapper__menu">
      ...
      <div class="manWrapper__menu__items">
         <div class="manWrapper__menu__item"><a style="color: <?=$menuId==""?"orange":"black"?>" href="index.php?sayfaKodu=49">Tüm Ürünler (<?=$menuCount["menununToplamUrunu"]?>)</a></div>
         <?php
            ...
            if($manFetchCount > 0) {
               foreach($manGoods as $man) {
                  ...
                  $urunSayinizDeyis->execute([$toMenu["urunSayi"], $man["id"]])?>
                    <div class="manWrapper__menu__item"><a style="color: <?=$menuId==$man["id"]?"orange":"black"?>" href="index.php?sayfaKodu=49&menuId=<?=$man["id"]?>"><?=$man["menuAdi"]?>  (<?=$toMenu["urunSayi"]?>)</a></div>
              <?php
               }
   ...
   <div class="manWrapper__items">
      <div class="manWrapper__items__search">
         <div class="row height d-flex justify-content-center align-items-center">
            <form action="index.php?sayfaKodu=49" method="post" class="">
               <?php
                  if($menuId !== "") {?>
                  ...
                  foreach($goods as $good) {
                     ...
                     <div class="manWrapper__item">
                        <div class="manWrapper__item__img">
                          <a href="kishi-ayakkabisi/<?=donusumleriGeriDondur($good["urun_adi"])?>/<?=donusumleriGeriDondur($good["id"]);?>"><img src="assets/images/UrunResimleri/Erkek/<?=donusumleriGeriDondur($good["urun_resmi_bir"])?>" alt=""></a>
                        </div>
