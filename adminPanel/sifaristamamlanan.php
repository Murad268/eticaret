<div class="kargolar">
   ...
   ?>
      ...
      <div class="addBank">
         <a href="index.php?sayfaKoduDis=0&sayfaKoduIc=53">Tamamlanmış Sifarişlər</a>
      </div>
      <?php
         ...
         if($bulunanSafyaSayisi>0) {?>
            <div class="paginationWrapper">
                  <nav aria-label="Page navigation example ">
                     <ul class="pagination">
                     <li class="page-item"><a class="page-link" href="index.php?sayfaKoduDis=0&sayfaKoduIc=54&sayfalama=1">&laquo;</a></li>
                     <?php
                        for($i = $sayfalama-$sayfalamaIcinButonSayisi; $i <= $sayfalama+$sayfalamaIcinButonSayisi; $i++) {
                           ...
                           if($sayfalama == $i) {
                              ...
                              echo "<li class=\"page-item\"><a class=\"page-link\" href=\"index.php?sayfaKoduDis=0&sayfaKoduIc=54&sayfalama=$curr\">$curr</a></li>";
                           }
                        }
                     }
                     ?>
                        
                        <li class="page-item"><a class="page-link"  href="index.php?sayfaKoduDis=0&sayfaKoduIc=54&sayfalama=<?=$bulunanSafyaSayisi?>">&raquo;</a></li>
                     </ul>
                  </nav>
               </div>
        <?php }
